...
<head>
  ...
  <meta name="keyword" content="VEHICLE IDENTIFICATION SYSTEM">
...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="inc/check.php" method="post">
        <h2 class="form-login-heading">sign in now</h2>
        <div class="login-wrap">
          <p><?php if (!empty($_SESSION['msg'])) {
          echo $_SESSION['msg'];
        } else {
         $_SESSION['msg']="";
        } ?></p>
          ...
          <br>
          <input type="password" class="form-control" name="password" placeholder="Password" autofocus required="required">
